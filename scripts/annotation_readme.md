...
For every image the main question is: **is the animal standing still, moving slightly, or clearly moving?**
...
1) Moving or standing?
   s = standing (crisp)   f = slight (a little smeared)   d = moving (clearly streaked)   u = unsure
...
2) If you can tell, which way is the HEAD pointing? The number keys are a compass,
   ...
   5 = axis only: you see the body/blur LINE but not which end is the head.
       Press 5 again to rotate the line through the eight orientations (every 22.5 deg)
       until it lies along the animal.
